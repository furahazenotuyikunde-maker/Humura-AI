...
const notifications: NotificationItem[] = [
  ...
  },
  {
    ...
    messageEn: 'We noticed you may be going through something difficult. MIND SUPPORTED, LIFE EMPOWERED — tap here to talk to Humura AI or call RBC helpline now.',
