...
const CommunityPage: React.FC = () => {
  ...
  const handleJoinCommunity = () => {
    const newNotif = {
      id: 'joined_community_' + Date.now(),
      type: 'wellness',
      titleEn: 'Welcome to the Community!',
      titleRw: 'Murakaza neza mu Muryango!',
      messageEn: "You've successfully joined our mental health community. We're glad to have you with us. 💚",
      messageRw: "Binjiye neza mu muryango wacu w'ubuzima bwo mu mutwe. Twishimiye ko muri kumwe natwe. 💚",
      timeEn: 'Just now',
      timeRw: 'Ubu ngubu',
      icon: 'Heart',
    ...
    const hasWelcome = notifications.some((n: any) => n.id.startsWith('joined_community_'));
    if (!hasWelcome) {
      notifications.unshift(newNotif);
      localStorage.setItem('Humura_notifications_v1', JSON.stringify(notifications));
      window.dispatchEvent(new CustomEvent('humura-notification-added'));
    }
  };

  const WHATSAPP_LINK = "https://chat.whatsapp.com/JY6lQTj2oH8KhRnzyvZiDK";
  ...
  return (
    <div className="community-page-wrapper">
      ...
      <section className="hero">
        ...
        <p className="hero-sub">Join the Humura AI mental health community — a free, anonymous WhatsApp space supported by verified professionals.</p>
        <div className="hero-stats">
          <div><span className="stat-val">Active</span><span className="stat-lbl">Professionals</span></div>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto' }}>
        ...
        <section className="section fade-up" id="groups">
          ...
          <p className="section-desc">7 dedicated groups, each monitored by professionals in that specialty. Join the whole community and access all groups.</p>
          <div className="groups-grid">
            ...
            <a 
              className="group-card crisis-card" 
              href={WHATSAPP_LINK} 
              target="_blank" 
              rel="noreferrer"
              onClick={handleJoinCommunity}
      ...
      <div className="cta-section fade-up">
        ...
        <p>Tap the button below, join the community, and you will have access to all 7 support groups and our verified professionals immediately.</p>
        <a 
          className="btn-wa" 
          href={WHATSAPP_LINK} 
          target="_blank" 
